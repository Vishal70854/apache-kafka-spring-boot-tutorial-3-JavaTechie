...
public class KafkaMessagePublisher {
    ...
    @Value("${app.topic.name}") // fetch the topic name from application.properties using @Value("${topic_variable_name}")
    private String topicName;

    // send message to topic from producer using below method sendEvents(user)
